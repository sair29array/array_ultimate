...
$Usuarios = $sair->mostrar_usuarios_array();
 ...
 ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">Usuarios Array / Usuarios con actividad en Array</h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover table-responsive"  id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        {
                                        	$id_user = $user["id"];
                                        	$activo = 0; /// si este valor deja de ser cero quiere decir que es un user activo y que se debe mostrar aqui porque este es un espacio para activos
	                                        foreach ($actividades as $actividad) 
	                                        {
	                                           $id_user_a = $actividad["id_usuario"];
	                                           
	                                           if ($id_user === $id_user_a) /////si el usuario no está en la tabla de contratos activoss entonces no se muestra
                                        			{
                                        				///////////////
			                                        	$activo = $activo + 1;
                                        				//////////////
